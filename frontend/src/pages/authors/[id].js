        ...
        <div className="p-10 mt-16 lg:mt-0">
          <div className="w-full flex flex-wrap items-center">
            <div className="flex flex-wrap items-center w-3/4">
              ...
              <h1 className="text-black-4 text-3xl font-semibold">
                Author Details
              </h1>
            </div>
            {!loading && (
              ...
              <div className="w-full bg-[#FFF] mt-5 rounded-xl p-5 flex-wrap">
                ...
                <div className="w-full flex flex-wrap mb-5">
                  ...
                  <Input
                    type={"email"}
                    readOnly={true}
                    placeholder={"Enter auhtor email"}
                ...
                <div className="w-full grid grid-cols-2 gap-x-4">
                  <div className="w-full flex flex-wrap mb-5">
                    ...
                    <Input
                      ...
                      defaultValue={data && data.accountHolderName}
                    />
                  </div>
                  <div className="w-full flex flex-wrap mb-5">
                    <label className="w-full text-[#555555] font-medium mb-2 text-sm">
                  ...
                  <div className="w-full flex flex-wrap mb-5">
                    ...
                    <Input
                      ...
                      defaultValue={data && data.ifscCode}
                    />
                  </div>
                </div>
              </div>
